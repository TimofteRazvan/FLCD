...
public class Parser {
    ...
    public ParseTreeNode parse(String inputString) {
        ...
        if (inputIndex == inputString.length() - 1) {
            System.out.println("Parsing successful!");
            return parseTreeRoot;
        } else {
